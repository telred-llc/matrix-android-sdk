...
public class MXWebRtcCall extends MXCall {
    ...
    static private VideoCapturer mCameraVideoCapturer = null; // Changed CameraVideoTrack to VideoTrack for implement Screen Share function
    ...
    public boolean switchRearFrontCamera() {
        if ((null != mCameraVideoCapturer) && (mCameraVideoCapturer instanceof CameraVideoCapturer) && (isSwitchCameraSupported())) {
            try {
